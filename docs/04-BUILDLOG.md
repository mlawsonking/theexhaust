...
| BUILD-01 | Archival fleet v1 (collectors → R2) | **in progress** — C1 + C5 + **C4 nhtsa-recalls** live-verified; nhtsa-complaints built + HEAD-verified (367 MB full-fetch deferred to Actions); C6/C8–C11 next; R2 deploy + fleet-green pending BUILD-00 |
