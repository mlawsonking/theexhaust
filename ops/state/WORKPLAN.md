...
### W-002b · Collector state-commit-back (dedupe persistence) — `next` (orchestrator decision 2026-07-28: **option (a) locked**)
...
### W-003 · Alarms + weekly session live — `queued` (follows W-002b)
